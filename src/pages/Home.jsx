...
const Home = () => {
  ...
  return (
    <div className="home">
      <Hero />
      <section className="what-we-do flex flex-col items-center justify-center min-h-[100vh] relative overflow-hidden text-white py-8">
        <img
          src={satisfied}
          alt=""
          className="zoom-in absolute top-0 left-0 right-0 bottom-0 h-full"
        />
        <div className="container flex flex-col items-center gap-12 bg-black bg-opacity-50 backdrop-blur-md py-20 rounded-md">
          ...
          <div className="flex flex-col gap-8 xl:gap-12 xl:flex-row ">
            <button className="white-btn" data-aos="fade-up">What we do</button>
            <button className="white-btn" data-aos="fade-up">Who we are</button>
            <button className="white-btn" data-aos="fade-up">Careers</button>
          </div>
        </div>
      </section>
      <OurMethods />
